    ...
    <Container className="my-5">
      <Row>
        <Col>
          ...
          <h3>Visi & Misi</h3>
          <p>
            <strong>Visi:</strong> Membangun masyarakat desa yang sejahtera,
            ramah lingkungan, dan harmonis.
          </p>
          <p>
            <strong>Misi:</strong>
            <ol>
              <li>Meningkatkan pendidikan dan layanan kesehatan.</li>
              <li>Mendorong praktik pertanian berkelanjutan.</li>
              <li>Mengembangkan infrastruktur dan layanan publik.</li>
            </ol>
          </p>
        </Col>
      </Row>
